...
* [OpenE2K](https://git.mentality.rip/OpenE2K/qemu-e2k) - Самостоятельная реализация qemu под Эльбрус
* [Compiler Explorer](https://ce.mentality.rip/) - Реализация Compiler Explorer с поддержкой E2K
